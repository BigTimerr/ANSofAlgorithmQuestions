...
//int main(){
//    unsigned long long x = 1234567891234;
//    bitset<64> message(x);
//    bitset<64> key(0000);
//
//    bitset<64> cipher = DES_ENC(message, key);
//    unsigned long  long plaintext = DES_DEC(cipher, key).to_ullong();
//    cout << cipher << endl;
//    cout << plaintext;
//
//}